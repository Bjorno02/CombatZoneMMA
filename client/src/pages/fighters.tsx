        ...
        <div className="max-w-[1280px] mx-auto px-8 md:px-12 lg:px-16">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div className="max-w-xl">
              <h2 className="text-3xl font-bold font-[Chakra_Petch] uppercase mb-8">
                For Fighters
              </h2>
              <p className="text-lg text-neutral-600 mb-10 leading-relaxed">
                Looking to compete in Combat Zone? We are always looking for top tier talent. Review
                the requirements and submit your application.
              </p>
              <ul className="space-y-5 mb-10">
                <li className="bg-white p-4 border border-neutral-200 font-bold text-neutral-800 flex justify-between items-center cursor-pointer hover:border-primary">
            ...
            <div className="bg-black text-white p-12 flex flex-col justify-center">
              <h3 className="text-2xl font-bold font-[Chakra_Petch] uppercase mb-6">
                Apply to Fight
              </h3>
              <p className="text-neutral-400 mb-10 text-lg leading-relaxed">
                Ready to step into the cage? Fill out our fighter application form to get on the
                radar of our matchmakers.
              </p>
              <Button className="bg-primary hover:bg-primary/90 text-white font-bold uppercase py-6">
                Fighter Application
              </Button>
            </div>
          </div>
