            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-12 scroll-reveal">
                ...
                <div className="space-y-6 mb-10">
                  <p className="text-lg leading-relaxed text-neutral-200">
                    <span className="text-primary font-bold">Combat Zone MMA</span> is New England's
                    longest-running mixed martial arts promotion. For over 24 years, we've been the
                    proving ground where the region's top fighters showcase their skills, compete
                    for championships, and launch their careers toward the highest levels of the
                    sport.
                  </p>
                  <p className="text-base leading-relaxed text-neutral-300">
                    Owned and operated by UFC veteran{" "}
                    <span className="text-primary font-bold">Calvin Kattar</span>, Combat Zone
                    combines decades of tradition with modern production values, hosting
                    professional events at the prestigious{" "}
                    <span className="font-bold text-white">SNHU Arena</span> in Manchester, New
                    Hampshire.
                  </p>
                </div>
              </div>
              ...
              <div className="lg:col-span-5 space-y-4 scroll-reveal scroll-reveal-delay-1 lg:mt-[25%] mt-8 lg:mt-[25%]">
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-lg hover:bg-white/15 transition-all">
                  ...
                  <p className="text-sm text-neutral-300">Professional title fights</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-lg hover:bg-white/15 transition-all">
                  <h3 className="text-lg font-bold font-[Chakra_Petch] uppercase text-white mb-2">
                    Talent Pipeline
                  </h3>
                  <p className="text-sm text-neutral-300">Path to the UFC</p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 p-6 rounded-lg hover:bg-white/15 transition-all">
                  <h3 className="text-lg font-bold font-[Chakra_Petch] uppercase text-white mb-2">
                    Premier Venue
